...
export default function Landing() {
  ...
  return (
    <div>
      ...
      {/* PROMO VIDEO + 3D ISO ARCHITECTURE */}
      <section className="relative border-t border-white/5 overflow-hidden">
        <div className="mx-auto max-w-[1500px] px-6 lg:px-10 py-24 grid grid-cols-12 gap-10 items-center">
          <div className="col-span-12 lg:col-span-6">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-amber-500 mb-4">
              PHOTOREALISTIC · TECH 3D · BLUEPRINT PREVIEW
            </div>
            ...
            <p className="text-slate-400 leading-relaxed mb-6 max-w-lg">
              Von der modularen GovStack-Ebene über den Excellent Hub bis zur
              institutionellen Verankerung — die Blaupause macht jede Schicht,
              jeden Prüfpfad und jeden Datenfluss sichtbar. Keine Blackbox,
              kein Vendor-Lock-in, volle Nachvollziehbarkeit.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/blueprint"
                data-testid="promo-cta-blueprint"
                className="inline-flex items-center gap-2 border border-amber-500/50 text-amber-400 hover:bg-amber-500 hover:text-black px-4 py-2.5 rounded-sm text-sm font-mono uppercase tracking-wider transition-colors"
              >
                <Layers size={14} />
                Blaupause öffnen
              ...
              <Link
                to="/validator"
                data-testid="promo-cta-validator"
                className="inline-flex items-center gap-2 border border-white/15 hover:border-blue-500/70 hover:text-blue-400 text-slate-200 px-4 py-2.5 rounded-sm text-sm font-mono uppercase tracking-wider transition-colors"
              >
                <PlayCircle size={14} />
                Live-Validator starten
              </Link>
            </div>
          </div>

          <div className="col-span-12 lg:col-span-6">
            <div className="relative border border-white/10 rounded-lg overflow-hidden bg-[#050914]">
              <video
                autoPlay
                muted
                loop
              ...
              <div className="absolute inset-0 pnia-video-overlay pointer-events-none" />
              <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-amber-500/20">
                <div className="text-[9px] font-mono uppercase tracking-[0.2em] text-amber-500">
                  Promo · CoE e.V. · Blaupause v1.0
                </div>
                <div className="mt-1 text-sm text-white font-serif">
                  Compliance ist Architektur — nicht Compliance-Marketing.
                </div>
              </div>
            </div>
            <div className="mt-6 border border-white/10 rounded-lg bg-[#050914] p-4">
              <Iso3DStack
                height={340}
                layers={[
                  { level: "Ebene 1", title: "GovStack · Modulare Plattform" },
                  { level: "Ebene 2", title: "CoE · Sicherer Workspace" },
                  { level: "Ebene 3", title: "Excellent Hub · Validierung" },
                  { level: "Ebene 4", title: "Inklusion · Barrierefreiheit" },
                  { level: "Ebene 5", title: "Compliance · Institutionell" },
                ]}
              />
              <div className="mt-2 flex items-center justify-between text-[10px] font-mono text-slate-500">
                <span>CSS-3D · GPU-transform · Isometric render</span>
                <span className="text-amber-400">© 2026 Daniel Pohl</span>
              </div>
            </div>
          </div>
        </div>
