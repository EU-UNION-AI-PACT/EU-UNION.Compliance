...
# Configuration
# ---------------------------------------------------------------------------
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://code-audit-fix-25.preview.emergentagent.com").rstrip("/")
# ISSUER_URL matches the value in backend/.env (used as `aud` for proof JWTs)
ISSUER_URL = os.environ.get("ISSUER_URL", "https://code-audit-fix-25.preview.emergentagent.com")
